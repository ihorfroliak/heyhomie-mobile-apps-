...
/**
 * Admin login (Build 21). Same shared `auth` client as the client app; admin
 * accounts are provisioned server-side (no self-register here). Role/tenant stay
 * server-side — the app only holds an opaque token.
 */
